...
export const heroData = {
  ...
  operationsSnapshot: {
    ...
    src: "/images/portal/portail-client-2026-09-25.jpg",
    avifSrcset: "/images/portal/portail-client-2026-09-25-640.avif 640w, /images/portal/portail-client-2026-09-25-1280.avif 1280w",
    alt: "Portail Sunelys de septembre 2026 : synthèse et prochaine action, avec des données de démonstration",
    items: [
  ...
  views: [
    {
      ...
      text: "L’espace client réunit l’avancement des démarches et les prochaines actions. Interface de septembre 2026, présentée avec des données de démonstration.",
      src: "/images/portal/portail-client-2026-09-25.jpg",
      avifSrcset: "/images/portal/portail-client-2026-09-25-640.avif 640w, /images/portal/portail-client-2026-09-25-1280.avif 1280w",
      alt: "Nouvel espace client Sunelys : synthèse et priorités sur un dossier de démonstration",
      width: 1280,
      height: 720,
    ...
    },
    {
      ...
      text: "Cet outil interne permet à l’équipe de retrouver les portails des communes pour préparer et suivre les dépôts. Capture de septembre 2026, sans données clients.",
      src: "/images/portal/portail-urbanisme-2026-09-25.jpg",
      avifSrcset: "/images/portal/portail-urbanisme-2026-09-25-640.avif 640w, /images/portal/portail-urbanisme-2026-09-25-1280.avif 1280w",
      alt: "Nouveau portail Sunelys : recherche d’un guichet urbanisme par commune, sans données clients",
      width: 1327,
      height: 733,
      sizes: "(max-width: 720px) calc(100vw - 3rem), (max-width: 1080px) calc(100vw - 6rem), 58vw",
